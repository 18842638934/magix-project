...
module.exports = Picker.extend({
    ...
    show: function(view, ops) {
        ...
        if (!vf) {
            ...
            vf = view.owner.mountVframe(id, 'coms/colorpicker/index', ops);
        }
        vf.invoke('show');
    }
});
