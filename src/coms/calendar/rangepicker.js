...
var Rangepicker = Picker.extend({
    tmpl: "<%if(quickDates.length){%><div class=\"mx-bd5-shortcuts-header\">快捷日期</div><div class=\"mx-bd5-shortcuts mx-bd5-clearfix\" mx-guid=\"x9481-\u001f\">@1-\u001f</div><%}%><div class=\"mx-bd5-shortcuts-header\">日期范围</div><div class=\"mx-bd5-datepicker mx-bd5-clearfix\" mx-guid=\"x9482-\u001f\">@2-\u001f</div><div class=\"mx-bd5-buttons mx-bd5-clearfix\"><button mx-click=\"picked()\" class=\"btn\">确定</button> <button mx-click=\"hide()\" class=\"btn\">取消</button></div>",
