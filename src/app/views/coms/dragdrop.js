...
module.exports = Magix.View.extend({
    tmpl: "<ul class=\"mx-b74-dragdrop clearfix\" id=\"dd_<%=id%>\"><li>a</li><li>b</li><li>c</li><li>d</li></ul><ul class=\"mx-b74-dragdrop clearfix dd2\" id=\"dd2_<%=id%>\"><li>1</li><li>2</li><li>3</li><li>4</li></ul><ul class=\"mx-b74-dragdrop dd3 clearfix\" id=\"dd3_<%=id%>\"></ul>",
    tmplData: [],
    render: function() {
        var me = this;
        me.$updater.set({
