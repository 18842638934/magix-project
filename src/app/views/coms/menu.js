...
module.exports = Magix.View.extend({
    tmpl: "<div id=\"m1_<%=id%>\" style=\"margin:20px;float:left\" mx-view=\"coms/menu/index\" mx-guid=\"x8c91-\u001f\">@1-\u001f</div><div id=\"m2_<%=id%>\" style=\"margin:20px;float:left\" mx-view=\"coms/menu/index\" mx-guid=\"x8c92-\u001f\" mx-pick=\"menu2()\">@2-\u001f</div><button mx-click=\"changeService()\" class=\"btn btn-size30\" style=\"margin:20px\">切换数据源</button><div style=\"width:300px;height:300px;line-height:300px;background:#ccc;margin:200px 200px 0 200px;float:left\" mx-contextmenu=\"showContextMenu()\">context menu</div>",
    tmplData: [{"guid":1,"keys":["list","width1"],"tmpl":"<script type=\"magix/config\"><%=JSON.stringify({list:list,width:width1})%></script>","selector":"div[mx-guid=\"x8c91-\u001f\"]","view":"coms/menu/index"},{"guid":2,"keys":["list","width2"],"tmpl":"<script type=\"magix/config\"><%=JSON.stringify({list:list,width:width2})%></script>","selector":"div[mx-guid=\"x8c92-\u001f\"]","view":"coms/menu/index"}],
