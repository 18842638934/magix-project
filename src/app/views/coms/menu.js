...
module.exports = Magix.View.extend({
    tmpl: {"html":"<div id=\"m1_<%=id%>\" style=\"margin:20px;float:left\" mx-view=\"coms/menu/index?list={list}&width={width1}\" mx-guid=\"x8c91-\u001f\"></div><div id=\"m2_<%=id%>\" style=\"margin:20px;float:left\" mx-view=\"coms/menu/index?list={list}&width={width2}\" mx-guid=\"x8c92-\u001f\" mx-pick=\"menu2()\"></div><button mx-click=\"changeService()\" class=\"btn btn-size30\" style=\"margin:20px\">切换数据源</button><div style=\"width:300px;height:300px;line-height:300px;background:#ccc;margin:200px 200px 0 200px;float:left\" mx-contextmenu=\"showContextMenu()\">context menu</div>","subs":[{"keys":["list","width1"],"selector":"div[mx-guid=\"x8c91-\u001f\"]","view":"coms/menu/index?list={list}&width={width1}"},{"keys":["list","width2"],"selector":"div[mx-guid=\"x8c92-\u001f\"]","view":"coms/menu/index?list={list}&width={width2}"}]},
