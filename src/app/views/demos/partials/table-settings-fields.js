...
module.exports = Picker.extend({
    tmpl: "<div class=\"mp-fec-cnt\"><div class=\"mp-fec-fields-wrapper clearfix\"><div class=\"mp-fec-fields\" mx-guid=\"x7f01-\u001f\">@1-\u001f</div><div class=\"mp-fec-sortable\" id=\"sortable_<%=id%>\"><ul mx-guid=\"x7f02-\u001f\">@2-\u001f</ul></div></div><div class=\"mp-fec-h-fields\" mx-guid=\"x7f03-\u001f\" id=\"hsortable_<%=id%>\">@3-\u001f</div><div class=\"mp-fec-buttons\"><button class=\"btn\" mx-click=\"enter();\">确定</button> <button class=\"btn\" mx-click=\"cancel();\">取消</button></div></div>",
