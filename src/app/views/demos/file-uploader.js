...
module.exports = Magix.View.extend({
    tmpl: "<div mx-view=\"coms/uploader/index\" class=\"mx-e95-uploader\">点击上传文件</div><div mx-view=\"coms/range/index\" mx-change=\"range()\"></div><div id=\"test\" class=\"mx-e95-test\"></div><button mx-click=\"test()\">Vframe created test</button>",
    tmplData: [],
    render: function() {
        var me = this;
        me.$updater.digest();
